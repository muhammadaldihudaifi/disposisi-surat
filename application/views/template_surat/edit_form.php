            ...
            <div class="card-body">
                <form action="<?php echo site_url('templatesurat/edit') ?>" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="hidden" name="id" value="<?= $template->id; ?>" required />
                        <input class="form-control" type="text" name="nama" value="<?= $template->nama; ?>" placeholder="Nama Pengirim" required />
                    </div>
                    <div class="mb-3">
                        <label>PERIHAL <code>*</code></label>
                        <input class="form-control" type="text" name="perihal" value="<?= $template->perihal; ?>" placeholder="PERIHAL SURAT" required />
                    </div>
                    <div class="mb-3">
                        <label>TUJUAN SURAT <code>*</code></label>
                        <input class="form-control" type="text" name="tujuan_surat" value="<?= $template->tujuan_surat; ?>" placeholder="TUJUAN SURAT" required />
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label>TANGGAL KIRIM <code>*</code></label>
                                <input class="form-control" type="date" name="tgl_kirim" value="<?= $template->tgl_kirim; ?>" placeholder="TANGGAL KIRIM SURAT" required />
                            </div>
                        </div>
                        <div class="col"></div>
                    </div>
